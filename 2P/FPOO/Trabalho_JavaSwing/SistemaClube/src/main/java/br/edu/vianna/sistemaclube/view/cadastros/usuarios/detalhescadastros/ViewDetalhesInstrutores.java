 ...
 * @author William
 */
public class ViewDetalhesInstrutores extends javax.swing.JDialog {

    /**
     * Creates new form ViewDetalhesAtividades
     */
    public ViewDetalhesInstrutores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbInstrutores = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Visualizar detalhes dos instrutores");
        ...
        tabPanelBuscar.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar instrutor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        tbInstrutores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "#", "Nome", "Sobrenome", "CPF", "Email", "Salário", "Especialidade", "Data Nasc.", "Data Registro", "Último Acesso"
            }
        ) {
        ...
        tbInstrutores.setShowGrid(true);
        tbInstrutores.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbInstrutoresMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbInstrutores);
        if (tbInstrutores.getColumnModel().getColumnCount() > 0) {
            tbInstrutores.getColumnModel().getColumn(0).setPreferredWidth(60);
            tbInstrutores.getColumnModel().getColumn(0).setMaxWidth(50);
            tbInstrutores.getColumnModel().getColumn(1).setMinWidth(110);
            tbInstrutores.getColumnModel().getColumn(2).setMinWidth(110);
            tbInstrutores.getColumnModel().getColumn(4).setMinWidth(110);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        carregarDadosDeInstrutores();
        txtIdLinhaClicada.setVisible(false);
    }//GEN-LAST:event_formWindowOpened

    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ViewCadastroInstrutor viewCadastroInstrutor = new ViewCadastroInstrutor(this, true);
    ...
    private void btnAlterarDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarDadosActionPerformed
        if (txtIdLinhaClicada.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Para alterar os dados de um instrutor clique sobre ele e então clique novamente em Alterar, " +
                            "na janela que se abrir clique no botão buscar, uma vez que o ID do instrutor já está definido, as informações dele serão trazidas da base de dados.",
                    "Info", JOptionPane.INFORMATION_MESSAGE);
        } else {
            ViewCadastroInstrutor viewCadastroInstrutor = new ViewCadastroInstrutor(this, true);
            int id = Integer.parseInt(txtIdLinhaClicada.getText());
            viewCadastroInstrutor.getTxtBuscarPorId().setText(String.valueOf(id));
            viewCadastroInstrutor.getTxtBuscarPorId().requestFocusInWindow();
            viewCadastroInstrutor.setVisible(true);
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        if (txtIdLinhaClicada.getText().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Para deletar o registro de um instrutor clique sobre ele e então clique novamente em Deletar",
                    "Info", JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private void btnBuscarPorNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPorNomeActionPerformed
        if (!txtBuscarPorNome.getText().isBlank()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Digite o nome do instrutor para realizar a busca!", "Campo de busca vazio", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void tbInstrutoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbInstrutoresMouseClicked
        escutarCliquesDoMouseNaTabela(evt);
    }//GEN-LAST:event_tbInstrutoresMouseClicked

    private void escutarCliquesDoMouseNaTabela(java.awt.event.MouseEvent evt) {
        int linha = tbInstrutores.rowAtPoint(evt.getPoint());
        if (linha >= 0) {
            int coluna = 0;
            Object valor = tbInstrutores.getValueAt(linha, coluna);
    ...
    private void realizarBuscaDeCadastroPorId() {
        ...
        try {
            ...
            if (instrutor == null) {
                ...
                preencherTabela(instrutor);
            }
        } catch (SQLException | ClassNotFoundException ex) {
            exibeMensageErroNaBase(ex);
        }
    }
    ...
    private void realizarBuscaDeCadastroPorNome() {
        ...
        try {
            instrutores = new InstrutorDAO().buscarPorNome(txtBuscarPorNome.getText());

            if (instrutores.isEmpty()) {
                JOptionPane.showMessageDialog(rootPane, "A busca não retornou nenhum resultado!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
            } else {
                preencherTabela(instrutores);
            }
        } catch (SQLException | ClassNotFoundException ex) {
            exibeMensageErroNaBase(ex);
        }
    ...
    private void realizarBuscaDeCadastroPorData() {
        List<Instrutor> instrutores;
        try {
            instrutores = new InstrutorDAO().buscarPorDataNasc(txtBuscarPorData.getText());
    ...
    private void realizarBuscaDeCadastroPorCpf() {
        Instrutor instrutor;
        try {
            instrutor = new InstrutorDAO().buscarPorCpf(txtBuscarPorCpf.getText().replaceAll("[^\\d]", ""));
    ...
    public void carregarDadosDeInstrutores() {
        List<Instrutor> instrutores;
        try {
            instrutores = new InstrutorDAO().buscarTodos();
            if (instrutores.isEmpty()) {
                if (!mensagemJaExibida) {
                    JOptionPane.showMessageDialog(rootPane, "Nenhum instrutor cadastrado.", "Aviso", JOptionPane.WARNING_MESSAGE);
    ...
    private void preencherTabela(List<Instrutor> instrutores) throws SQLException, ClassNotFoundException {
        DefaultTableModel tabela = (DefaultTableModel) tbInstrutores.getModel();

        limparTabela();

        for (Instrutor ins : instrutores) {
            String[] linha = getDadosInstrutores(ins);
            tabela.addRow(linha);
        }
    ...
    private void preencherTabela(Instrutor ins) throws SQLException, ClassNotFoundException {
        DefaultTableModel tabela = (DefaultTableModel) tbInstrutores.getModel();
    ...
    private static String[] getDadosInstrutores(Instrutor ins) {
        return new String[]{
                String.valueOf(ins.getId()),
                ins.getNome(), ins.getSobrenome(),
                ins.getCpf(), ins.getEmail(),
                String.format("%.2f", ins.getSalario()),
                String.valueOf(ins.getEspecializacao()),
                FormataData.formataDataParaExibicao(ins.getDataNascimento()),
                FormataDataHora.formataDataHoraParaExibicaoComSegundos(ins.getDataRegistro()),
                FormataDataHora.formataDataHoraParaExibicaoSemSegundos(ins.getDataUltimoAcesso())
        };
    }
    ...
    private void centralizarConteudosDaTabela() {
        ...
        tbInstrutores.getColumnModel().getColumn(0).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(1).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(2).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(3).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(4).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(5).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(6).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(7).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(8).setCellRenderer(cetralizarConteudo);
        tbInstrutores.getColumnModel().getColumn(9).setCellRenderer(cetralizarConteudo);
    }

    private void exibeMensageErroNaBase(Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDetalhesInstrutores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewDetalhesInstrutores dialog = new ViewDetalhesInstrutores(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tbInstrutores;
