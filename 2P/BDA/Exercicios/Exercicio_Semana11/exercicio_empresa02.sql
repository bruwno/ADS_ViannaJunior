...
-- 5. Recupere o nome dos empregados não que tem dependente. Use NOT IN. | NOT IN é o != (diferente) para mais de um valor.
...
-- 7. Recupere o nome dos cargos que estão ocupados por algum empregado. Use IN. | IN é o = (igual) para mais de um valor.
