...
import br.com.williamsilva.veiculo.PersonalizaCarro;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("|Concessionária| Carros 1.0 têm 10% de desconto no IPI!\n");

        Carro carro;
        PersonalizaCarro personalizarCarro = new PersonalizaCarro();

        carro = personalizarCarro.selecionarModelo();
